...
$campaginData = array(
    ...
    'min_cashback_amt' => $_POST['min_cashback_amt'] ?? $campaginDataResult->min_cashback_amt ?? null,
    'max_cashback_amt' => $_POST['max_cashback_amt'] ?? $campaginDataResult->max_cashback_amt ?? null,
    'min_invoice_products' => $_POST['min_invoice_products'] ?? $campaginDataResult->min_invoice_products ?? null,
                    ...
                    <div class="col-md-10">
                        <div class="authincation-content">
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <a class="d-block text-right"><i class="fa fa-window-close text-danger mr-1 p-1" style="font-size:30px;" ></i></a>
                                        ...
                                        <form action="" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="switcher">
                                                            ...
                                                            <select name="validation_team" class="form-control input_val">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="switcher">
                                                            <label for="" class="w-100"><strong>Minimumn Cashback Amt</strong>
                                                            <!-- <div class="d-inline-block float-lg-right">
                                                                <input type="checkbox" id="toggle-5" class="toggle-switch"/>
                                                                <span><small></small></span>
                                                            </div> -->
                                                            </label>
                                                            <input type="text" name="min_cashback_amt" id="" class="form-control input_val" value="0.00">
                                                        </div>
                                                    </div>                                                     
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row align-items-center">
                                                    <div class="col-6">
                                                        <div class="switcher">
                                                            <label for="toggle-7" class="w-100"><strong>Max Cashback Card</strong>
                                                            <div class="d-inline-block float-lg-right">
                                                                <input type="checkbox" id="toggle-7" class="toggle-switch"/>
                                                                <span><small></small></span>                                                                
                                                            </div>
                                                            </label>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="switcher">
                                                            <label for="toggle-3" class="w-100"><strong>Mininimum Product Qty.(total)</strong>
                                                            <div class="d-inline-block float-lg-right">
                                            ...
                                            <div class="form-group">                                                
                                                <div class="row">
                                                    <div class="col-6 mt-2">
                                                        <div class="switcher">
                                                            <label for="toggle-5" class="w-100"><strong>Minimumn Invoice Products</strong>
                                                            <div class="d-inline-block float-lg-right">
                                                                <input type="checkbox" id="toggle-5" class="toggle-switch"/>
                                                                <span><small></small></span>
                                                            </div>
                                                            </label>
                                                            <input type="text" name="min_invoice_products" id="" class="form-control input_val" value="0" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                             </div>

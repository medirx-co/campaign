                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-primary btn-block"><a href="#" class="text-white">Raise Ticket</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example3" class="table table-hover table-responsive-sm" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <div class="d-flex align-items-center"><i class="fa fa-circle text-warning mr-1"></i> Hold</div>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <div class="d-flex align-items-center"><i class="fa fa-circle text-danger mr-1"></i> Not Resolved</div>
                                                </td>
                                                <td></td>
                                            </tr>
